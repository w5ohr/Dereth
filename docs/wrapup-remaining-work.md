...
| ✅ **Aetheria slot/level/surge system** | ~~Slots unlock L75/150/225, leveled aetheria, set bonus + surge procs (currently 3 flat gems).~~ DONE — three colour slots on the paperdoll (blue L75 / yellow L150 / red L225); coalesced lumps drop from tier-4+ foes, revealed into one of **five set sigils** (Defense/Destruction/Fury/Growth/Vigor) with level-scaled passives (2pc ×1.5, 3pc ×2) and **surges** that proc in combat (Protection/Destruction/Affliction/Regeneration/Festering, shared 8s ICD); aetheria **level 1→5 by absorbing your XP while worn**. Legacy absorbed sigils keep their power; the absorb kind no longer drops. Verified live (gates, swaps, set math, surges, level-ups, save round-trip). | L | auth-gaps I5 |
